...
baseOutDir = 'results/2023/tnpEleID/afterEGMTalk_newfit/preBPIX_v0_abseta/'
...
samplesDef = {
    'data'   : tnpSamples.Run2023_130X_ReReco_preBPIX['data_Run2023C1_Filtered'].clone(),
    'mcNom'  : tnpSamples.Run2023_130X_ReReco_preBPIX['DY_amc_preBPIX'].clone(),
    'mcAlt'  : tnpSamples.Run2023_130X_ReReco_preBPIX['DY_pow_preBPIX'].clone(),
    #'mcAlt'  : tnpSamples.Run2023_130X_ReReco_preBPIX['DY_mg_preBPIX'].clone(),
    'tagSel' : tnpSamples.Run2023_130X_ReReco_preBPIX['DY_amc_preBPIX'].clone(),
}

## can add data sample easily
samplesDef['data'].add_sample( tnpSamples.Run2023_130X_ReReco_preBPIX['data_Run2023C2'] )
samplesDef['data'].add_sample( tnpSamples.Run2023_130X_ReReco_preBPIX['data_Run2023C3'] )
samplesDef['data'].add_sample( tnpSamples.Run2023_130X_ReReco_preBPIX['data_Run2023C4'] )
...
weightName = 'weights_data_Run2023C.totWeight' #'weights_2023_runBCD.totWeight' 
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_weight(weightName)
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_weight(weightName)
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_weight(weightName)
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('PU_Trees/DY_amc_preBPIX_ele.pu.puTree.root')
#if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_puTree('PU_Trees/DY_mg_preBPIX_ele.pu.puTree.root')
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_puTree('PU_Trees/DY_pow_preBPIX_ele.pu.puTree.root')
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('PU_Trees/DY_amc_preBPIX_ele.pu.puTree.root')

#PU_Trees/DY_pow_preBPIX_ele.pu.puTree.root
