...
baseOutDir = 'results/2022/tnpEleID/afterEGMTalk_newfit/preEE_v0_abseta'
...
samplesDef = {
    ...
    'mcNom'  : tnpSamples.Run2022_130X_ReReco_preEE['DY_amc_preEE'].clone(), #origianl
    #'mcNom'  : tnpSamples.Run2022_130X_ReReco_preEE['DY_mg_preEE'].clone(), #just for test
    ...
    #'tagSel' : tnpSamples.Run2022_130X_ReReco_preEE['DY_mg_preEE'].clone(),
}

## can add data sample easily
#samplesDef['data'].add_sample( tnpSamples.Run2022_130X_ReReco_preEE['data_Run2022D'] )
...
#if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('PU_Trees/DY_mg_preEE_ele.pu.puTree.root')
...
#if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('PU_Trees/DY_mg_preEE_ele.pu.puTree.root') #just for test

#PU_Trees/DY_pow_preEE_ele.pu.puTree.root
