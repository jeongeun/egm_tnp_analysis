...
#for sName in tnpSamples.Run2023_130X_ReReco_preBPIX.keys():    
#    sample = tnpSamples.Run2023_130X_ReReco_preBPIX[sName]
#for sName in tnpSamples.Run2023_130X_ReReco_postBPIX.keys():    
#    sample = tnpSamples.Run2023_130X_ReReco_postBPIX[sName]
for sName in tnpSamples.Run2022_130X_ReReco_preEE.keys():    
    sample = tnpSamples.Run2022_130X_ReReco_preEE[sName]
#    if sample is None : continue
#for sName in tnpSamples.Run2022_130X_ReReco_postEE.keys():    
#    sample = tnpSamples.Run2022_130X_ReReco_postEE[sName]
    if sample is None : continue
