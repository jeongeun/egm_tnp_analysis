...
#
    ...
    'mix_2023_25ns_EraC_PoissonOOTPU'  :[ 2.38822148706e-05, 4.75152134008e-05, 6.30191527793e-05, 6.68452240771e-05, 8.1025250051e-05,
    ...
    'mix_2023_25ns_EraD_PoissonOOTPU' :[0.000158878446531, 3.72079495004e-05, 4.81640545476e-05, 4.57853820338e-05, 4.48623875183e-05,
...
puDirEOS = './PUTree/'
puDir2022 = '/cms/ldap_home/taebh/CMSSW_12_6_0/src/'
...
#
#puDataEpoch = {
#    '2022_runB' : puDir2022 + 'Run2022B_pileup.root',
#    '2022_runC' : puDir2022 + 'Run2022C_pileup.root',
#    '2022_runD' : puDir2022 + 'Run2022D_pileup.root' ,
#    '2022_runE' : puDir2022 + 'Run2022E_pileup.root' ,
#    '2022_runF' : puDir2022 + 'Run2022F_pileup.root',
#    '2022_runG' : puDir2022 + 'Run2022G_pileup.root',
#    '2022_run3' : puDir2022 + 'Run2022_pileup.root',
#}
#nVtxDataEpoch = {
#    '2022_runB' : puDir2022 + 'Run2022B_pileup.root',
#    '2022_runC' : puDir2022 + 'Run2022C_pileup.root',
...
puDataEpoch = {
#    '2022_runBCD'  : './PU_Trees/pileupHistogram-Cert_Collisions2022_355100_357900_eraBCD_GoldenJson-13p6TeV-69200ub-99bins.root',
#    '2022_runEFG' : './PU_Trees/pileupHistogram-Cert_Collisions2022_359022_362760_eraEFG_GoldenJson-13p6TeV-69200ub-99bins.root'
#    '2023_runC' : './PU_Trees/pileupHistogram-Cert_Collisions2023_366403_369802_eraBC_GoldenJson-13p6TeV-69200ub-99bins.root'
    '2023_runD' : './PU_Trees/pileupHistogram-Cert_Collisions2023_369803_370790_eraD_GoldenJson-13p6TeV-69200ub-99bins.root'
}
nVtxDataEpoch = {
#    '2022_runBCD'  : './PU_Trees/pileupHistogram-Cert_Collisions2022_355100_357900_eraBCD_GoldenJson-13p6TeV-69200ub-99bins.root',
#    '2022_runEFG' : './PU_Trees/pileupHistogram-Cert_Collisions2022_359022_362760_eraEFG_GoldenJson-13p6TeV-69200ub-99bins.root'
...
### create a tree with only weights that will be used as friend tree for reweighting different lumi periods
    ...
    tmc = None
#    print( 'sample.tnpTree ==> ', sample.tnpTree)
    if sample.tnpTree is None:
        dirs = fmc.GetListOfKeys()
        print( 'dirs ==> ', fmc.GetListOfKeys())
        for d in dirs:
...
#### can reweight vs nVtx but better to reweight v truePU
    ...
    #mcEvts = tree2array( tmc, branches = ['truePU','event_nPV'])#,'rho'] )
...
#            print( "--------------------------")
            ...
            if puType == 2 and int(evt['rho']) < puMax:
                ...
                if ievt%10000 == 0 : print( "pu= ", pu, "evt['truePU']= ",evt['truePU'])
                if evt['truePU']> 0 and evt['truePU']<99: 
                    pud = puDataArray[pu][evt['truePU']] 
                    pum = pumc[evt['truePU']]
                    #print('pud= ', pud , ', pum= ', pum)
            puw = 0
            if pum > 0: 
                puw  = pud/pum
		#print('puweight= ', puw)
...
#                    print( evt['truePU'],puw)
    ...
    print( "=====================> Loop end")
    #print( "weights[pu]=", weights[pu])
    #print( "totWeights[pu]=", totWeights[pu])

    newFile    = rt.TFile( sample.puTree, 'recreate')
    print( "=====New File Created================", sample.puTree)
