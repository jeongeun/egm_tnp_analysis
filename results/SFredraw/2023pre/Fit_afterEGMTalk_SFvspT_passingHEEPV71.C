void Fit_afterEGMTalk_SFvspT_passingHEEPV71()
{
//=========Macro generated from canvas: totopT/totopT
//=========  (Wed Oct 16 18:25:37 2024) by ROOT version 6.22/06
...
//   0.1356282,
   ...
   //MC efficiency EE 
   Double_t Graph2_fx1005[14] = { 175, 225, 42.5, 105, 65, 37.5, 95, 140, 47.5, 55, //350, 
120,  75, 85};
   Double_t Graph2_fex1005[14] = { 25, 25, 2.5, 5, 5, 2.5, 5, 10, 2.5, 5, //100, 
10, 5, 5};
...
//     0.919,
   ...
   Double_t Graph2_fey1005[14] = {
     0.028869742058242918,
     0.0335682078528306,
     0.004797390933682509,
     0.017283497840639844,
     0.01435511720137645,
     0.004591324740248244,
     0.026647719863274966,
     0.01711714037081279,
     0.006977405896500695,
     0.004764374584124005,
//     0.13518686212920672,
     0.027933086906883377,
     0.015558259537058299,
     0.022768263683949002,
}; 
   ...
   Double_t Graph3_fey1006[14] = {
     0.01068877744734267,
     0.02361619063367058,
     0.005009955685292568,
     0.008832763521766538,
     0.035714703691860805,
     0.0034943891650594037,
     0.023900625335872384,
     0.014850525339994503,
     0.003795178415122028,
     0.009481519292246669,
     0.029769141288977955,
     0.013928391866974461,
     0.008472657670145937,
     0.005569791222642308,
}; 
   ...
   totopT->SaveAs("Fit_EleID_SFvspT_passingHEEPV71_2023preBPIX_rebin.pdf"); 
