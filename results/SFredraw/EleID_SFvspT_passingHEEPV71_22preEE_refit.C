#include <iostream>
#include <iomanip>
void EleID_SFvspT_passingHEEPV71_22preEE_refit()
{
//=========Macro generated from canvas: totopT/totopT
//=========  (Fri Sep 27 04:29:54 2024) by ROOT version 6.22/06
...
//////////////////////// Fitting EE
  ...
  // SF DATA EB Black   
   ...
   TF1 *fitFuncConst_EB = new TF1("fitFuncConst_EB", "[0]", 35, divideThresh);
   ...
   TF1 *fitFuncLin_EB = new TF1("fitFuncLin_EB", "[0] + [1]*x", 35, divideThresh);
   ...
   TString textConst_EB    = Form("EB Const Fit (pT 35-%.0f): SF = %.3f #pm (95%% CI: %.3f)", divideThresh, parConst_EB,  ci95_EB);
   ...
   TF1 *fitFuncConst_EB1 = new TF1("fitFuncConst_EB1", "[0]", divideThresh, 1000);
   ...
   TF1 *fitFuncLin_EB1 = new TF1("fitFuncLin_EB1", "[0] + [1]*x", divideThresh, 1000);
   ...
   TString textConst_EB1    = Form("EB Const Fit (pT %.0f-1000): SF = %.3f #pm (95%% CI: %.3f)",divideThresh, parConst_EB1,  ci95_EB1);
...
// ------------>Primitives in pad: totopT_up
  ...
  // MC Eff --- ADDED BY HAND EE, EB using calculate_mcerr.py
  ...
  0.04968691755877664,
  0.031457195559400575,
  0.005862568570546002,
  0.018527662140168284,
  0.0228639165649893,
  0.019683835916398714,
  0.08111264236999596,
  0.02324629014472877,
  0.01538866126908314,
  };
   ...
   0.005769780164570707,
   0.03989773162450203,
   0.030516194015713847,
   0.05319263161344096,
   0.005111758074488404,
   0.013858051993641868,
   0.005896404381585229,
   0.030623896618984014,
   0.07484326662452802,
   0.056878096425539475,
...
//   totopT->cd();
   ...
   totopT->SaveAs("EleID_SFvspT_passingHEEPV71_2022preEE_v3_refit_divide100.pdf");
