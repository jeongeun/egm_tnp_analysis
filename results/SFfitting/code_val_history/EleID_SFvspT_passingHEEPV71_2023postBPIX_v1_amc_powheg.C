void EleID_SFvspT_passingHEEPV71_2023postBPIX_v1_amc_powheg()
{
//=========Macro generated from canvas: totopT/totopT
//=========  (Mon Sep 16 01:49:20 2024) by ROOT version 6.22/06
...
// ------------>Primitives in pad: totopT_up
  ...
  // MC efficiency -jeongeun added EE, EB using calculate_mcerr.py
   ...
   0.0042054181133226115, 
   0.03810384911436481,   
   0.04389471699039836,   
   0.03836953752598615,   
   0.006940002198138022,  
   0.028814497954445666,  
   0.005202990418359006,  
   0.009231552377869141,  
   0.10312322337683395,   
   0.024936038781053545,  
   0.022804102321418475,  
   };
   ...
   0.0027886971238561603, 
   0.03743750773306636,   
   0.03212865710389279,   
   0.015133521702351875,  
   0.0577866541321573,    
   0.013698239340164262,  
   0.0023243595295871205, 
   0.010363458158450441,  
   0.08927505498093614,   
   0.01028586695463505,   
   0.037366795467591064,  
   };
   ...
   totopT->SaveAs("EleID_SFvspT_passingHEEPV71_2023postBPIX_v1_amc_powheg.pdf");
