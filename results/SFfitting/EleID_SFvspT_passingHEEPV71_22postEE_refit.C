#include <iostream>
#include <iomanip>
void EleID_SFvspT_passingHEEPV71_22postEE_refit()
{
//=========Macro generated from canvas: totopT/totopT
//=========  (Fri Sep 27 16:23:27 2024) by ROOT version 6.22/06
...
// ------------>Primitives in pad: totopT_up
   ...
   0.008060283793926976,
   0.016166367163012285,
   0.04416423685462301,
   0.005830696132903729,
   0.006662639565464369,
   0.008857379174286919,
   0.04549644471987861,
   0.012936848211432013,
   0.08809985483489416,
   0.006990347342321495,
   0.006123481563626479
   };
   ...
   0.005863855189617912,
   0.010623352472541508,
   0.06137184720604847,
   0.04117448047435584,
   0.005146418513501359,
   0.019020599583088077,
   0.006871943750462079,
   0.016651955714133734,
   0.06688391097718069,
   0.01654474210037611,
   0.057003778777626135,
   };
   ...
   totopT->SaveAs("EleID_SFvspT_passingHEEPV71_2022postEE_v0_refit_full.pdf");
